...
module.exports = (sequelize) => {
  const Shift = sequelize.define(
    'Shift',
    {
      ...
      // Intervalul si zilele definesc sablonul schimbului.
      ...
      // Aceste campuri controleaza pauza si afisarea in UI.
  ...
  Shift.associate = (models) => {
    // Legam schimbul de departament si de entitatile care il folosesc.
